...
void printPredictUsage()
{
    std::cerr
        ...
        << "  -tries            how many times tries to find a random kmer in the sequence [default 1] increse it to find more hits\n"
        << "  -minProbability   minimum probability to report sequences [default 0.8]\n"
        << "  -threads          number of threads to use\n"
        << "  -minReadChunkSize minimum chunk of reads to process at the time [default 10000] increase it to make it faster but increases ram memory\n\n"
